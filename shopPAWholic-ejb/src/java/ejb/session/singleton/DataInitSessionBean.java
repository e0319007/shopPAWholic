...
public class DataInitSessionBean {
    ...
    private void initializeData() {
        try {
            ...
            Seller seller11 = new Seller("Furry Wheel", "furrywheel@email.com", "61713887", "furrywheel", new Date(119, 11, 22), false, 0, null );
            Seller seller12 = new Seller("Happy Paws", "haoppyPawse@email.com", "85291432", "happypaw", new Date(119, 10, 22), false, 0, null);
            Seller seller13 = new Seller("Pets Love", "petslove@email.com", "91506502", "welove2016pets", new Date(119, 7, 22), false, 0, null);
            Seller seller14 = new Seller("Pets' Station", "petsstation@email.com", "61480093", "pets2019station", new Date(119, 6, 12), false, 0, null);
            Seller seller15 = new Seller("Superpets", "superp3ts@email.com", "94601631", "superP3TS", new Date(119, 0, 14), false, 0, null);
            Seller seller16 = new Seller("All 4 Pets", "all4pets@email.com", "90760582", "All4Pets", new Date(119, 1, 14), false, 0, null);
            Seller seller17 = new Seller("Dunk N' Dogs", "dnd@email.com", "67163148", "DnD2020", new Date(119, 7, 3), false, 0, null);
            Seller seller18 = new Seller("Furbaby", "furbaby@email.com", "61862980", "furbabyyy", new Date(119, 5, 5), false, 0, null);
            Seller seller19 = new Seller("ZooKeeper", "zookeeper@email.com", "91482340", "z00keeper_pwd", new Date(119, 8, 14), false, 0, null);
            Seller seller20 = new Seller("City Dog", "cityDogs@email.com", "99330096", "cityDOG", new Date(119, 0, 28), false, 0, null);
            ...
            listingSessionBeanLocal.createNewListing(new Listing("LIST006", "Dog Litter Tray", "Pet Toilet for Dog, Pee Training Tray Litter Box for Dog Puppy Pet with Protection Wall", new BigDecimal("30.00"), "https://ae01.alicdn.com/kf/HTB1zOt1avjsK1Rjy1Xaq6zispXaP.jpg", 30, date), categoryLitters.getCategoryId(), tagIdsEmpty, seller7.getUserId());
